...
class BookingForm extends Form
{
    ...
    {
        $this
            ->add('from_account_id', 'select2', ['label' => trans('partymeister-accounting::backend/bookings.from_account'), 'choices' => Account::lists('name', 'id')->toArray(), 'empty_value' => trans('partymeister-accounting::backend/bookings.book_in')])
            ->add('to_account_id', 'select2', ['label' => trans('partymeister-accounting::backend/bookings.to_account'), 'choices' => Account::lists('name', 'id')->toArray(), 'empty_value' => trans('partymeister-accounting::backend/bookings.book_out')])
