...
class ItemForm extends Form
{
    ...
    public function buildForm()
    {
        $this->add('item_type_id', 'select2', [
                ...
                'choices' => ItemType::pluck('name', 'id')->toArray()
            ])
             ->add('name', 'text',
                 [ 'label' => trans('partymeister-accounting::backend/items.name'), 'rules' => 'required' ])
             ->add('description', 'textarea',
                 [ 'label' => trans('partymeister-accounting::backend/items.description'), 'rules' => 'required' ])
             ->add('internal_description', 'textarea',
                 [ 'label' => trans('partymeister-accounting::backend/items.internal_description') ])
            ...
            //->add('can_be_ordered', 'checkbox', ['label' => trans('partymeister-accounting::backend/items.can_be_ordered')])
             ...
             ->add('cost_price_without_vat', 'text',
                 [ 'label' => trans('partymeister-accounting::backend/items.cost_price_without_vat') ])
             ...
             ->add('pos_can_book_negative_quantities', 'checkbox',
                 [ 'label' => trans('partymeister-accounting::backend/items.pos_can_book_negative_quantities') ])
             ...
             ->add('pos_create_booking_for_item_id', 'select2', [
                 ...
                 'choices'     => Item::pluck('name', 'id')->toArray(),
                 'empty_value' => trans('motor-backend::backend/global.please_choose')
             ])
             ->add('submit', 'submit', [
