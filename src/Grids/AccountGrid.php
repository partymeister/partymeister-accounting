...
class AccountGrid extends Grid
{
    ...
    protected function setup()
    {
        ...
        $this->addAction(trans('partymeister-accounting::backend/accounts.edit_pos'), 'backend.pos.edit', ['class' => 'btn-warning'])->needsPermissionTo('backend.bookings.create')->onCondition('has_pos', true);
