...
class ItemResource extends BaseResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            // DEPRECATED pos_earnings_account is deprecated
            //'pos_earnings_account'             => new AccountResource($this->pos_earnings_account),
            //'pos_earnings_account_id'          => (int) $this->pos_earnings_account_id,
            'pos_cost_account'                 => new AccountResource($this->pos_cost_account),
            'pos_cost_account_id'              => (int) $this->pos_cost_account_id,
            'pos_create_booking_for_item'      => new ItemResource($this->pos_create_booking_for_item),
            'pos_create_booking_for_item_id'   => (int) $this->pos_create_booking_for_item_id,
