...
class PartymeisterAccountingApiAccountTypeTest extends TestCase
{
    ...
    {
        $this->json('GET', '/api/account_types/1')->seeStatusCode(401)->seeJson(['error' => 'Unauthenticated.']);
    }
    ...
    public function returns_404_for_non_existing_record()
    {
        ...
        $this->json('GET', '/api/account_types/1?api_token='.$this->user->api_token)->seeStatusCode(404)->seeJson([
    ...
    public function fails_if_trying_to_create_without_payload()
    {
        ...
        $this->json('POST', '/api/account_types?api_token='.$this->user->api_token)->seeStatusCode(422)->seeJson([
    ...
    {
        $this->json('POST', '/api/account_types?api_token='.$this->user->api_token)->seeStatusCode(403)->seeJson([
            'error' => 'Access denied.',
        ]);
    }
    ...
    {
        $this->user->givePermissionTo($this->writePermission);
        $this->json('POST', '/api/account_types?api_token='.$this->user->api_token, [
    ...
    /** @test */
    public function can_show_a_single_account_type()
    {
        $this->user->givePermissionTo($this->readPermission);
    ...
    {
        $this->user->givePermissionTo($this->readPermission);
        $this->json('GET', '/api/account_types?api_token='.$this->user->api_token)->seeStatusCode(200)->seeJson([
            'total' => 0,
        ]);
    }

    /** @test */
    public function can_show_multiple_account_type()
    {
        $this->user->givePermissionTo($this->readPermission);
    ...
    /** @test */
    public function can_search_for_a_account_type()
    {
        $this->user->givePermissionTo($this->readPermission);
        $records = create_test_account_type(10);
    ...
    /** @test */
    public function fails_if_trying_to_update_nonexisting_account_type()
    {
        $this->user->givePermissionTo($this->writePermission);
        $this->json('PATCH', '/api/account_types/2?api_token='.$this->user->api_token)->seeStatusCode(404)->seeJson([
            'message' => 'Record not found',
        ]);
    }

    /** @test */
    public function fails_if_trying_to_modify_a_account_type_without_payload()
    {
        $this->user->givePermissionTo($this->writePermission);
        $record = create_test_account_type();
    ...
    /** @test */
    public function fails_if_trying_to_delete_a_non_existing_account_type()
    {
        $this->user->givePermissionTo($this->deletePermission);
        $this->json('DELETE', '/api/account_types/1?api_token='.$this->user->api_token)->seeStatusCode(404)->seeJson([
            'message' => 'Record not found',
        ]);
    }
